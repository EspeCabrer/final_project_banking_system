...
import com.ironhack.banksystem.account.accountTypes.savings.SavingsEntity;
...
public class DemoApplication implements CommandLineRunner {
	...
	public void run(String... args)  {
		...
		roleRepository.saveAll(List.of(new RoleEntity(EnumRole.ADMIN), new RoleEntity(EnumRole.ACCOUNT_HOLDER)));
		...
		adminRepository.save(new AdminEntity("maria", passwordEncoder.encode("password"), adminRole ));
		...
		savingsRepository.save(new SavingsEntity(new Money(BigDecimal.valueOf(3000)), user2, null, null, null, passwordEncoder.encode("secretKey")));
		savingsRepository.save(new SavingsEntity(new Money(BigDecimal.valueOf(1500)), user3, null, null, null, passwordEncoder.encode("secretKey")));
